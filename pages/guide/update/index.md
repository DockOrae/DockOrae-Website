...
title:
  ...
  zh-CN: 更新概览
description:
  en: Update methods for each DockOrae installation type and backup considerations before upgrading.
  zh-CN: DockOrae 各安装方式的更新方法与升级前备份注意事项。
categories:
  - guide
  - update
top: 92000
...
4. If the panel cannot start, reinstall while keeping the data using the [uninstall](/guide/uninstall/) procedure, or restore from a backup

---

See the detailed update steps for your installation type:

- [Compose Update](/guide/update/docker) — manual compose / docker run deployments
